...
// }
//
// func calculateEntropy(distribution map[any]float64) float64 {
// 	var entropy float64
...
// }
//
// func mutualInformation(jcg JointCharGen, cg1, cg2 CharGen) float64 {
// 	var mi float64
// 	for k, p := range jcg.distribution {
// 		a, b := k[0], k[1]
// 		pA := cg1.distribution[a]
// 		pB := cg2.distribution[b]
...
// 	fmt.Printf("H(cg1) = %f\n", calculateEntropy(cg1.distribution))
// 	fmt.Printf("H(cg2) = %f\n", calculateEntropy(cg2.distribution))
// 	fmt.Printf("H(jcg) = %f\n", jointEntropy(jcg))
// 	fmt.Printf("I(cg1;cg2) = %f\n", mutualInformation(jcg, cg1, cg2))
// }
